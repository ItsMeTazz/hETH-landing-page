...
export default function Accordion({
  ...
  return (
    <Component>
      <button
        className="flex items-center w-full text-lg font-medium text-left py-5 border-t border-zinc-200"
      ...
      <div
        ref={accordion}
        className="text-zinc-600 overflow-hidden transition-all duration-300 ease-in-out"
